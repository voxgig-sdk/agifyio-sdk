...
type GetAgeEntity struct {
	name    string
	client  *core.AgifyioSDK
...
func NewGetAgeEntity(client *core.AgifyioSDK, entopts map[string]any) *GetAgeEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GetAgeEntity) GetName() string { return e.name }
...
func (e *GetAgeEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *GetAgeEntity) Deleted() bool {
	return e.deleted
}


func (e *GetAgeEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewGetAgeEntity(e.client, opts)
}

func (e *GetAgeEntity) Data(args ...any) any {
...
func (e *GetAgeEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *GetAgeEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *GetAgeEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *GetAgeEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *GetAgeEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *GetAgeEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *GetAgeEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
