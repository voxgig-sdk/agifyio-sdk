...
func (sdk *AgifyioSDK) OptionsMap() map[string]any {
...
func (sdk *AgifyioSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *AgifyioSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *AgifyioSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AgifyioSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *AgifyioSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *AgifyioSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("AgifyioSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *AgifyioSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *AgifyioSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("AgifyioSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
