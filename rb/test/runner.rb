...
module AgifyioTestRunner
  ...
  def self.env_override(m)
    live = getenv("AGIFYIO_TEST_LIVE")
    override = getenv("AGIFYIO_TEST_OVERRIDE")
    ...
    explain = getenv("AGIFYIO_TEST_EXPLAIN")
    m["AGIFYIO_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = AgifyioTestRunner
Helpers = AgifyioHelpers
Vs = VoxgigStruct
