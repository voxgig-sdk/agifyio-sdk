...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/agifyio` | `npm install @voxgig-sdk/agifyio` |
| Python | `voxgig-sdk-agifyio` | `pip install voxgig-sdk-agifyio` |
| PHP | `voxgig-sdk/agifyio` | `composer require voxgig-sdk/agifyio` |
| Golang | `github.com/voxgig-sdk/agifyio-sdk/go` | `go get github.com/voxgig-sdk/agifyio-sdk/go` |
| Ruby | `voxgig-sdk-agifyio` | `gem install voxgig-sdk-agifyio` |
| Lua | `voxgig-sdk-agifyio` | `luarocks install voxgig-sdk-agifyio` |
