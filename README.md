...
Estimate age from names.

Learn more about Agify.io at [agify.io](https://agify.io/).

This is an unofficial SDK for the Agify.io public API, generated by Voxgig with [`@voxgig/sdkgen`](https://github.com/voxgig/sdkgen). It is not affiliated with, endorsed by, or sponsored by the upstream API provider.
...
This SDK exposes the API as a small set of **semantic entities** — GetAge — that you
