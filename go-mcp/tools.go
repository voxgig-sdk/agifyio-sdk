...
type Args struct {
	Entity string         `json:"entity" jsonschema:"get_age"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.AgifyioSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "agifyio_list",
		Description: "List records from Agifyio. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "agifyio_load",
		Description: "Load a single record from Agifyio. " +
...
func runOp(client *sdk.AgifyioSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.AgifyioSDK, name string) (sdk.AgifyioEntity, error) {
	switch strings.ToLower(name) {
	case "get_age":
		return client.GetAge(nil), nil
