...
// Agifyio SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class AgifyioMakeRequest
{
    public static function call(AgifyioContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new AgifyioResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new AgifyioResponse($fetched);
        } else {
