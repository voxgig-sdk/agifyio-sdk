...
class AgifyioRbacFeature extends AgifyioBaseFeature
{
    ...
    private function _required(AgifyioContext $ctx): ?string
    {
    ...
    private function _reject(AgifyioContext $ctx, string $required): void
    {
    ...
    private function _track(AgifyioContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
