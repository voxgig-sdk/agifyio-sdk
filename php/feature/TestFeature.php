...
// Agifyio SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class AgifyioTestFeature extends AgifyioBaseFeature
{
    ...
    public function init(AgifyioContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (AgifyioContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (AgifyioContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(AgifyioContext $ctx, $op, $args): array
    {
