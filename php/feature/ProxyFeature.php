...
class AgifyioProxyFeature extends AgifyioBaseFeature
{
    ...
    public function init(AgifyioContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (AgifyioContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
