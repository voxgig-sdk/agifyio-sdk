...
// Agifyio SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (AgifyioSDK::test)
...
{
    private const SDK_CLASS = 'AgifyioSDK';
    ...
    private const SDK_BASE = 'agifyio_sdk';
