...
class GetAgeDirectTest extends TestCase
{
    public function test_direct_load_get_age(): void
    {
        $setup = get_age_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-get_age", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
