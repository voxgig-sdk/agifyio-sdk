...
class AgifyioTestRunner
{
    ...
    {
        $live = self::getenv('AGIFYIO_TEST_LIVE');
        $override = self::getenv('AGIFYIO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('AGIFYIO_TEST_EXPLAIN');
...
class_alias('AgifyioTestRunner', 'Runner');
class_alias('AgifyioHelpers', 'Helpers');
