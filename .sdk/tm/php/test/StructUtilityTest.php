...
// Agifyio SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = AgifyioOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(AgifyioOmni::structfix($now, Struct::undef()))
                        !== json_encode(AgifyioOmni::structfix($val, Struct::undef()))) {
