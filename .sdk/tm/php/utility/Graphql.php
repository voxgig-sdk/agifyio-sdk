...
class AgifyioGraphql
{
    ...
    // equivalent.
    public static function body(AgifyioContext $ctx): mixed
    {
    ...
    public static function errors(AgifyioContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
