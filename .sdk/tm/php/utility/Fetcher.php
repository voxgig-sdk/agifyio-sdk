...
// Agifyio SDK utility: fetcher

class AgifyioFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; AgifyioSDK/1.0)';
    ...
    public static function call(AgifyioContext $ctx, string $fullurl, array $fetchdef): array
    {
