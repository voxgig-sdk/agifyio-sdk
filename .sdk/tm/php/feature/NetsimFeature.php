...
class AgifyioNetsimFeature extends AgifyioBaseFeature
{
    ...
    private function _simulate(AgifyioContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(AgifyioContext $ctx, array $applied): void
    {
        $client = $this->client;
