...
class AgifyioRatelimitFeature extends AgifyioBaseFeature
{
    ...
    private function _acquire(AgifyioContext $ctx): void
    {
    ...
    private function _track(AgifyioContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
