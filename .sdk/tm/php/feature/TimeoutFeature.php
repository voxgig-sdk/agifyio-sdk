...
class AgifyioTimeoutFeature extends AgifyioBaseFeature
{
    ...
    private function _with_timeout(AgifyioContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(AgifyioContext $_ctx, float $ms): void
    {
        $client = $this->client;
