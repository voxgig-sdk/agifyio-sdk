...
class AgifyioCacheFeature extends AgifyioBaseFeature
{
    ...
    private function _through(AgifyioContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
