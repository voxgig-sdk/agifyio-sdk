...
class AgifyioStreamingFeature extends AgifyioBaseFeature
{
    ...
    private function _iterate(AgifyioResult $result): \Generator
    {
    ...
    private function _streamable(AgifyioContext $ctx): bool
    {
