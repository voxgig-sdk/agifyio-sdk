...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = AgifyioOmni.make_runner(TEST_JSON_FILE, AgifyioSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : AgifyioOmni.errify(err)
    end
