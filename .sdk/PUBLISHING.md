...
|---|---|---|
| `ts/` | @voxgig-sdk/agifyio-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/agifyio-sdk \
      --repository voxgig-sdk/agifyio-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/agifyio-sdk` shows it, and
`npm trust revoke @voxgig-sdk/agifyio-sdk --id=<id>` removes it.
