...
from agifyio_sdk.utility import register

# Load features
from agifyio_sdk.feature.base_feature import AgifyioBaseFeature
from agifyio_sdk.features import _has_feature, _make_feature
...
class AgifyioSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = AgifyioUtility()
        self._utility = utility

        from agifyio_sdk.config import shared_config
    ...
    def get_utility(self):
        return AgifyioUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("AgifyioSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def GetAge(self, data=None) -> "GetAgeEntity":
        ...
        from agifyio_sdk.entity.get_age_entity import GetAgeEntity
