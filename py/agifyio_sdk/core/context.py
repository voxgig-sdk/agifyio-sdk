...
from agifyio_sdk.core.helpers import get_ctx_prop, to_map
...
class AgifyioContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, AgifyioResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return AgifyioError(code, msg, self)
