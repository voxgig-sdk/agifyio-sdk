# Agifyio SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions AgifyioSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both AgifyioSDK(...) and AgifyioSDK.test(...) become
#      AgifyioSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "agifyio_sdk"
_SDK_CLASS = "AgifyioSDK"
