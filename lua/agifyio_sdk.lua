...
AgifyioSDK._make_feature = _make_feature


function AgifyioSDK.new(options)
  local self = setmetatable({}, AgifyioSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function AgifyioSDK:options_map()
...
function AgifyioSDK:get_utility()
  return Utility.copy(self._utility)
end


function AgifyioSDK:get_root_ctx()
  return self._rootctx
end


function AgifyioSDK:prepare(fetchargs)
...
function AgifyioSDK:direct(fetchargs)
...
-- by passing it.
function AgifyioSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function AgifyioSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "AgifyioSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function AgifyioSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = AgifyioSDK.new(sdkopts)
  sdk.mode = "test"
