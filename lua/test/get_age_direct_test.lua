...
describe("GetAgeDirect", function()
  it("should direct-load-get_age", function()
    local setup = get_age_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-get_age", setup.live and "live" or "unit")
...
function get_age_direct_setup(mockres)
