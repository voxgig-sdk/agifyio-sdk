...
func registerSDKWords(r *eng.Registry, client *sdk.AgifyioSDK) {
...
func runOp(client *sdk.AgifyioSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
