...
function envOverride(m) {
    if ('TRUE' === process.env.AGIFYIO_TEST_LIVE ||
        'TRUE' === process.env.AGIFYIO_TEST_OVERRIDE) {
    ...
    m.AGIFYIO_TEST_EXPLAIN = process.env.AGIFYIO_TEST_EXPLAIN || m.AGIFYIO_TEST_EXPLAIN;
    return m;
}
