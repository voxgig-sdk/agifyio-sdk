...
(0, node_test_1.describe)('GetAgeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-get_age', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-get_age', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.AGIFYIO_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.AgifyioSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.AGIFYIO_APIKEY,
        }));
        let idmap = env['AGIFYIO_TEST_GET_AGE_ENTID'];
    ...
    const client = new __1.AgifyioSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=GetAgeDirect.test.js.map